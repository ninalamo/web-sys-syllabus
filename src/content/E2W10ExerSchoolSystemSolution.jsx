export default function E2W10ExerSchoolSystemSolution() {
  const code = `// Week 10 — Model & ViewModel examples
  ...
  return (
    <div className="page-content code-page">
      <div className="code-header">
        <span className="code-filename">school-system-solution.cs</span>
