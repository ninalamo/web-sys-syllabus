export default function E3W1ExerLegacyInventoryStarter() {
  const code = `// Week 1: Legacy ES5 Product Inventory — Starter Code
  ...
  return (
    <div className="page-content code-page">
      <div className="code-header">
        <span className="code-filename">legacy-inventory-starter.js</span>
