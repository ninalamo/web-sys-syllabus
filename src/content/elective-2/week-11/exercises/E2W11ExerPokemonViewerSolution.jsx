export default function E2W11ExerPokemonViewerSolution() {
  const code = `// Week 11 — Pokemon DTO and Controller
  ...
  return (
    <div className="page-content code-page">
      <div className="code-header">
        <span className="code-filename">pokemon-viewer-solution.cs</span>
