export default function E2W6PresSlideNotes() {
  return (
    <div className="page-content">
      <h1>Week 6 — Presentation Notes</h1>
      <ol>
        <li>Title: Controllers &amp; Action Results</li>
        <li>The Waiter's Responses Analogy</li>
        <li>IActionResult Interface</li>
