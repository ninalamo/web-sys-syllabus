export default function E3W3ExerStarterCatalog() {
  const code = `// Week 3: Untyped Product Catalog — Starter (JavaScript)
  ...
  return (
    <div className="page-content code-page">
      <div className="code-header">
        <span className="code-filename">starter-catalog.ts</span>
