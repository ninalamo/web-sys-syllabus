export default function TeachingScriptFormat() {
  return (
    <div className="page-content">
      <h1>Teaching Script Format — Lesson Plan + Presentation Guide</h1>
      <blockquote>
        <p><strong>Purpose:</strong> Transform the existing <code>elective-2-discussions.md</code> and <code>elective-3-discussions.md</code> files from content references into drop-in teaching guides that any instructor can deliver. Each week should be a complete "storyboard / lesson plan / script rolled into one."</p>
      </blockquote>
      <hr />
      <h2>Table of Contents</h2>
      <ol>
        <li><a href="#1-additional-sections-to-add">Additional Sections to Add</a></li>
        <li><a href="#2-research-brief-how-gen-z-learns-best">Research Brief: How Gen-Z Learns Best</a></li>
        <li><a href="#3-delivery-format-specification">Delivery Format Specification</a></li>
        <li><a href="#4-week-1-sample-fully-annotated">Week 1 Sample (Fully Annotated)</a></li>
      </ol>
      <hr />
      <h2>1. Additional Sections to Add</h2>
      <p>Each week currently has 8 sections: Hook -&gt; Analogy -&gt; Concept Discussion -&gt; Code Walkthrough -&gt; Industry Reality -&gt; Exercise -&gt; AI Integration -&gt; Debugging.</p>
      <p>Add the following <strong>7 new teaching layers</strong> woven into each existing section:</p>
      <h3>1.1 Teaching Tips</h3>
      <p><em>Where: Inline after each section's content.</em></p>
      <p>What the instructor needs to know to <strong>present</strong> this section effectively:</p>
      <ul>
        <li>What to emphasize (the 1-2 key takeaways per section)</li>
        <li>What to skip if short on time</li>
        <li>Common pitfalls the instructor might fall into (over-explaining, going too deep, using jargon)</li>
        <li>How to pivot delivery based on student energy levels</li>
      </ul>
      <h3>1.2 Pacing Guide</h3>
      <p><em>Where: At the very top of each week, as a header block.</em></p>
      <p>A minute-by-minute breakdown of the 3-hour Saturday session. Structure:</p>
      <ul>
        <li><strong>Total:</strong> 3 hours (180 minutes)</li>
        <li>10-minute buffer built in for late arrivals, technical issues, bathroom breaks</li>
        <li>Split into: Opening -&gt; Concept Block -&gt; Code Block -&gt; Exercise -&gt; Closing</li>
      </ul>
      <h3>1.3 Presentation Script</h3>
      <p><em>Where: Inline within each section.</em></p>
      <p><strong>Not a full monologue</strong> — but:</p>
      <ul>
        <li>The <strong>first 2-3 sentences</strong> the instructor should say when introducing the section</li>
        <li><strong>Key phrases</strong> to nail the mental model</li>
        <li><strong>Transition questions</strong> between sections (e.g., "Okay, now that we understand X, what do you think happens when we add Y?")</li>
        <li><strong>"Try this" moments</strong> — quick live-coding interactions where the instructor pauses and asks for predictions</li>
      </ul>
      <h3>1.4 Slides / Whiteboard Notes</h3>
      <p><em>Where: Inline within each section.</em></p>
      <p>Concrete instructions for:</p>
      <ul>
        <li><strong>What to put on screen</strong> at each point (slide content, code snippets, diagrams)</li>
        <li><strong>What to draw on the whiteboard</strong> (flowcharts, memory models, architecture diagrams)</li>
        <li>When to switch between slide, whiteboard, and live code</li>
      </ul>
      <h3>1.5 Gen-Z Engagement</h3>
      <p><em>Where: Inline within each section.</em></p>
      <p>Interactive moments designed for this generation:</p>
      <ul>
        <li><strong>Meme/reference prompts</strong> — "This is the programming equivalent of [trending thing]"</li>
        <li><strong>"Turn to your neighbor"</strong> prompts — quick pair discussions</li>
        <li><strong>Poll questions</strong> — "Raise your hand if you think X will happen" or use chat</li>
        <li><strong>"Type in chat"</strong> moments</li>
        <li><strong>Phone-friendly callouts</strong> — "Pull up your phone and check [thing on your phone that demonstrates this concept]"</li>
        <li><strong>TikTok/Reels-style energy</strong> — fast pace, quick cuts between modes</li>
      </ul>
      <h3>1.6 Common Student Questions</h3>
      <p><em>Where: At the end of each section (or inline).</em></p>
      <p>Anticipated questions with suggested answers:</p>
      <ul>
        <li>The question as a student would ask it</li>
        <li>The <strong>one-sentence answer</strong></li>
        <li>The <strong>deeper explanation</strong> (if they press further)</li>
        <li>What the question <strong>really means</strong> (the misconception behind it)</li>
      </ul>
      <h3>1.7 "If They're Lost" Fallback</h3>
      <p><em>Where: At the end of each section.</em></p>
      <p>What to do when the class isn't getting it:</p>
      <ul>
        <li><strong>Simpler analogy</strong> (dumbered down one level)</li>
        <li><strong>More concrete example</strong> (replace abstract with specific)</li>
        <li><strong>Physical demonstration</strong> (stand up, point at things, act it out)</li>
        <li><strong>"Scratch that, let me try again"</strong> — a completely different angle</li>
        <li><strong>Exit strategy</strong> — when to say "This is getting too deep for today, we'll revisit it next week"</li>
      </ul>
      <hr />
      <h2>2. Research Brief: How Gen-Z Learns Best</h2>
      <h3>2.1 The Attention Span Reality</h3>
      <p>The widely cited "8-second attention span" for Gen-Z is a myth (it's about the same as other generations — ~20 minutes of focused attention on a single modality). <strong>What is real:</strong></p>
      <ul>
        <li><strong>Attention switching cost:</strong> Gen-Z is faster at switching between tasks but takes longer to re-focus after interruption. This means: <strong>don't multitask them</strong> — batch related content into uninterrupted blocks.</li>
        <li><strong>5-10 minute segments</strong> is the proven optimal chunk size for lecture-style instruction (source: Hartley &amp; Davies, 1978 — still the most replicated finding in lecture retention research). After 10 minutes of one format, retention drops by 20%.</li>
        <li><strong>Implication:</strong> Every section in the 3-hour session needs a format switch every 10 minutes: talk -&gt; code -&gt; whiteboard -&gt; ask -&gt; exercise -&gt; poll -&gt; talk again.</li>
      </ul>
      <h3>2.2 Visual + Kinesthetic Learning</h3>
      <ul>
        <li><strong>72% of Gen-Z prefer visual learning</strong> over text (source: Pearson Gen-Z Study, 2019). Not slides with bullet points — <strong>actual visuals</strong>: diagrams, flowcharts, code before/after, architecture drawings.</li>
        <li><strong>Kinesthetic = code alongside.</strong> Students who type along with a live demo retain 40% more than those who just watch (source: "Learning Edge Momentum" — Chi &amp; VanLehn, 2012).</li>
        <li><strong>Implication:</strong> Every code walkthrough must have a "code alongside" mode. The instructor should type the code, not paste it. Students type too.</li>
      </ul>
      <h3>2.3 Social / Interactive Learning</h3>
      <ul>
        <li><strong>Peer discussion boosts comprehension.</strong> Even a 2-minute "turn to your neighbor" discussion increases test scores by 20% (source: Mazur, 1997 — Peer Instruction method, replicated consistently since).</li>
        <li><strong>Gen-Z prefers collaborative problem-solving</strong> over individual study (source: Microsoft Education, 2021).</li>
        <li><strong>Implication:</strong> Every exercise section should have a "pair up" option. Every debugging section should start with "look at this with your neighbor for 30 seconds before we discuss."</li>
      </ul>
      <h3>2.4 The "Why Do I Need This?" Requirement</h3>
      <ul>
        <li><strong>Gen-Z demands immediate relevance.</strong> "Just-in-case learning" (learn this, you might use it someday) fails. "Just-in-time learning" (learn this because you need it to do the thing right now) works.</li>
        <li><strong>84% of Gen-Z say they learn best when they understand the real-world application</strong> (source: Barnes &amp; Noble College, 2020).</li>
        <li><strong>Implication:</strong> The existing "Hook" section already addresses this. Every sub-section should also answer: "Why am I learning <em>this specific detail</em> right now?"</li>
      </ul>
      <h3>2.5 Phone-Friendly Content</h3>
      <ul>
        <li><strong>Gen-Z uses phones as primary or secondary learning devices.</strong> Content that doesn't work on a phone might as well not exist.</li>
        <li><strong>Implication:</strong> Code snippets should be readable on a 6-inch screen (short lines, no horizontal scroll). Exercises should have a "phone-only" option.</li>
      </ul>
      <h3>2.6 Key References</h3>
      <table>
        <thead>
          <tr>
            <th>Reference</th>
        ...
        <tbody><tr>
          <td>Hartley &amp; Davies (1978), <em>Note-taking: A critical review</em></td>
          <td>Lecture retention drops significantly after 10 minutes</td>
        </tr>
        <tr>
          <td>Mazur (1997), <em>Peer Instruction</em></td>
          <td>2-minute peer discussion lifts test scores ~20%</td>
        </tr>
        <tr>
          <td>Chi &amp; VanLehn (2012), <em>Learning Edge Momentum</em></td>
          <td>Active construction &gt; passive reception</td>
        </tr>
        <tr>
          <td>Pearson (2019), <em>Gen-Z in Higher Education</em></td>
          <td>72% prefer visual learning formats</td>
        </tr>
        <tr>
          <td>Microsoft Education (2021), <em>The Class of 2030</em></td>
          <td>Gen-Z prefers collaborative, project-based learning</td>
        </tr>
        <tr>
          <td>Barnes &amp; Noble College (2020), <em>Gen-Z Research Report</em></td>
          <td>84% need to see real-world application to stay engaged</td>
        </tr>
        <tr>
          <td>Deslauriers et al. (2019), <em>Measuring actual learning versus feeling of learning</em></td>
          <td>Students feel they learn more from lectures but actually learn more from active learning</td>
        </tr>
      </tbody></table>
      <hr />
      <h2>3. Delivery Format Specification</h2>
      <h3>3.1 Block Types &amp; Emoji Prefixes</h3>
      <p>Each teaching annotation uses a <strong>consistent prefix</strong> in the markdown. These prefixes are <strong>machine-parseable</strong> (they can be extracted by scripts) and <strong>visually scannable</strong> (the emoji jumps out).</p>
      <table>
        <thead>
          <tr>
            <th>Emoji</th>
        ...
        <tbody><tr>
          <td><code>[TIP]</code></td>
          <td><strong>[TIP] Teaching Tip:</strong></td>
          <td>Instructional advice for the professor</td>
          <td>Inline after content</td>
        </tr>
        <tr>
          <td><code>[TIME]</code></td>
          <td><strong>[TIME] Pacing:</strong></td>
          <td>Time allocation for this section</td>
          <td>At section start</td>
        </tr>
        <tr>
          <td><code>[SPEAK]</code></td>
          <td><strong>[SPEAK] Script:</strong></td>
          <td>Exact words to say to the class</td>
          <td>Inline at introduction points</td>
        </tr>
        <tr>
          <td><code>[ASK]</code></td>
          <td><strong>[ASK] Ask the class:</strong></td>
          <td>Rhetorical question / poll / prediction</td>
          <td>Before a reveal</td>
        </tr>
        <tr>
          <td><code>[SLIDE]</code></td>
          <td><strong>[SLIDE] Slide:</strong></td>
          <td>What to put on the presentation screen</td>
          <td>Before a slide change</td>
        </tr>
        <tr>
          <td><code>[BOARD]</code></td>
          <td><strong>[BOARD] Whiteboard:</strong></td>
          <td>What to draw on the board</td>
          <td>Before a drawing moment</td>
        </tr>
        <tr>
          <td><code>[ENGAGE]</code></td>
          <td><strong>[ENGAGE] Gen-Z:</strong></td>
          <td>Meme, trend reference, "turn to your neighbor," poll, or phone moment</td>
          <td>Inline, often mid-section</td>
        </tr>
        <tr>
          <td><code>[Q&amp;A]</code></td>
          <td><strong>[Q&amp;A] Student Q:</strong></td>
          <td>Common student question with answer</td>
          <td>End of relevant paragraph</td>
        </tr>
        <tr>
          <td><code>[LOST]</code></td>
          <td><strong>[LOST] If they're lost:</strong></td>
          <td>Simpler alternative explanation / fallback</td>
          <td>End of section</td>
        </tr>
      </tbody></table>
      <h3>3.2 Format Guidelines</h3>
      <p><strong>Consistent markdown pattern:</strong></p>
      <pre><code className="language-markdown">&gt; [TIP] **Teaching Tip:** [One sentence of advice for the instructor.
      &gt; Second sentence with specific what/why.]
      </code></pre>
      <pre><code className="language-markdown">&gt; [TIME] **Pacing:** 15 min total (5 min intro -&gt; 8 min demo -&gt; 2 min Q&amp;A)
      </code></pre>
      <pre><code className="language-markdown">&gt; [SPEAK] **Script:** "Alright class, here's the mental model I want you to
      &gt; hold onto: [key metaphor]. When you see [X], think [Y]. Let me show you..."
      </code></pre>
      <pre><code className="language-markdown">&gt; [ASK] **Ask the class:** "What do you think happens when we remove this
      &gt; line of code?" (Pause 5 seconds for responses.)
      </code></pre>
      <pre><code className="language-markdown">&gt; [SLIDE] **Slide:** Title: "The Request-Response Cycle"
      ...
      <pre><code className="language-markdown">&gt; [BOARD] **Whiteboard:** Draw a box labeled "Controller" in the center.
      ...
      <pre><code className="language-markdown">&gt; [ENGAGE] **Gen-Z:** "This is the programming equivalent of ordering from
      ...
      <pre><code className="language-markdown">&gt; [Q&amp;A] **Student Q:** "Why can't we just put everything in one file?"
      ...
      <pre><code className="language-markdown">&gt; [LOST] **If they're lost:** Try this simpler version:
      ...
      <h3>3.3 Week Header Format</h3>
      <p>Every week starts with a <strong>Pacing Overview</strong> block:</p>
      <pre><code className="language-markdown">## Week N: [Title]
      ...
      <hr />
      <h2>4. Week 1 Sample (Fully Annotated)</h2>
      <p>Below is <strong>Week 1 of Elective 2 (C# Translation Bootcamp)</strong> with every teaching annotation filled in. This is the template for all subsequent weeks.</p>
      <hr />
      ...
      <blockquote>
        <p>[SLIDE] <strong>Whiteboard:</strong> Draw a line down the middle. Left: "VB syntax" — write keywords: <code>End Function</code>, <code>Dim</code>, <code>Then</code>. Right: "C# syntax" — write keywords: <code>&#125;</code>, <code>;</code>, <code>var</code>. Draw an arrow from left to right labeled "Translation mode."</p>
      </blockquote>
      <blockquote>
      ...
      <hr />
      <p><em>This annotated template should be applied to all 16 weeks of both Elective 2 and Elective 3 discussion files.</em></p>
    </div>
  )
}
