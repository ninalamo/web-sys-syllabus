export default function E3W14ExerSolutionIntegrationTests() {
  const code = `// Week 14: Integration Tests — Solution (ApiTests.cs)
  ...
  return (
    <div className="page-content code-page">
      <div className="code-header">
        <span className="code-filename">solution-integration-tests.cs</span>
