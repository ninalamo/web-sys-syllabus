export default function E3W11ExerSolutionTodoApp() {
  const code = `// Week 11: Full-Stack Todo Integration — Solution (React)
  ...
  return (
    <div className="page-content code-page">
      <div className="code-header">
        <span className="code-filename">solution-todo-app.jsx</span>
