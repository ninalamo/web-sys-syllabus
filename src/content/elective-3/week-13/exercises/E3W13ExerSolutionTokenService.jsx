export default function E3W13ExerSolutionTokenService() {
  const code = `// Week 13: JWT Token Generation — Solution (TokenService.cs)
  ...
  return (
    <div className="page-content code-page">
      <div className="code-header">
        <span className="code-filename">solution-token-service.cs</span>
