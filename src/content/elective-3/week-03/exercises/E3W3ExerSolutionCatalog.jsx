export default function E3W3ExerSolutionCatalog() {
  const code = `// Week 3: Typed Product Catalog — Solution (TypeScript)
  ...
  return (
    <div className="page-content code-page">
      <div className="code-header">
        <span className="code-filename">solution-catalog.ts</span>
        <span className="code-lang">TYPESCRIPT</span>
      </div>
      <pre className="language-typescript"><code className="language-typescript">{code}</code></pre>
    </div>
  )
}
